# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-27 11:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subjects', models.CharField(blank=True, max_length=30, verbose_name='Subjects')),
                ...
                ('availability', models.CharField(blank=True, max_length=30, verbose_name='Availability')),
                ('about', models.CharField(blank=True, max_length=30, verbose_name='About Me')),
                ('role', models.CharField(choices=[('T', 'Tutor'), ('S', 'Student')], max_length=1)),
                ('avatar', models.ImageField(blank=True, null=True, upload_to=b'static/media/images/avatars/', verbose_name=b'profile picture')),
